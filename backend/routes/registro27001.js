...
const pool = require('../db/db'); // pool de MySQL

// Ruta POST para guardar registro ISO 27001 (sin auth por ahora)
router.post('/registro27001', async (req, res) => {
  try {
    const {
    ...
    // Truncado y conversión de datos según la tabla
    const data = [
